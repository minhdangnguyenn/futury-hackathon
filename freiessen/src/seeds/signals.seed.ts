export const signalsSeed = [
  // ── UC1: Competitor Moves ─────────────────────────────────────────
  {
    ...
    title: 'Grundfos launches AI-powered hydronic balancing system for retrofits',
    summary:
      'Grundfos announces an AI-assisted balancing kit that reduces commissioning time and improves comfort in retrofits.',
    entities: [
    ...
    evidence_urls: [
      {
        url: 'https://www.grundfos.com/news/ai-hydronic-balancing',
        label: 'Grundfos Press Release',
      },
  ...
  },
  {
    signal_type: 'emerging_tech' as const,
    source: 'simulated_release',
    title: 'Startup PipeSense raises EUR12M for ultrasonic leak detection wearable',
    summary:
